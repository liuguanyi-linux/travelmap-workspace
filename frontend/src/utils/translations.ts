export const TRANSLATIONS: any = {
  ...
  'ko-KR': {
    ...
    home: {
      explore: '세계 탐험',
      subtitle: '호텔, 레스토랑, 명소 등을 검색하세요. 20개 이상의 언어 지원.'
    },
    modal: {
      recentSearch: '최근 검색', noHistory: '검색 기록 없음', clear: '기록 지우기',
    ...
    booking: {
      ...
      confirm: '예약 확인', submitting: '제출 중...',
      note: '지금 결제할 필요 없습니다. 숙소에서 결제하세요.'
    },
    locationPrompt: {
      title: '현재 위치 사용',
    ...
    toast: {
      ...
      reviewFailed: '리뷰 게시 실패', sentToPhone: '휴대전화로 전송되었습니다',
      linkCopied: '링크가 클립보드에 복사되었습니다', routeDev: '경로 기능 개발 중',
      ticketDev: '티켓 시스템 곧 출시 예정', langSwitched: '언어가 변경되었습니다'
    }
  }
};
